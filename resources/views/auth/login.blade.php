...
<head>
    ...
    <title>Iniciar Sesión — Estética Jazmín</title>
...
<body class="min-h-screen bg-[#F9E8F2] flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-10 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-1 text-sm">Bienvenida de vuelta</p>
        </div>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            ¿No tienes cuenta?
            <a href="{{ route('register') }}" class="text-[#B5517A] font-medium hover:underline">Regístrate aquí</a>
        </p>
